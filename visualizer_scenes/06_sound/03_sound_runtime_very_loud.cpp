...
tft.fillRoundRect(22, 93, 112, 10, 2, TFT_RED);
tft.fillRect(134, 93, 4, 10, TFT_BLACK);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.setTextDatum(TC_DATUM);
tft.setTextColor(TFT_RED, TFT_BLACK);
tft.drawString("Muy ruidoso", 80, 109);
