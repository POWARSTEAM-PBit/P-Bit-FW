...
tft.fillRoundRect(22, 93, 52, 10, 2, TFT_YELLOW);
tft.fillRect(74, 93, 64, 10, TFT_BLACK);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.setTextDatum(TC_DATUM);
tft.setTextColor(TFT_YELLOW, TFT_BLACK);
tft.drawString("Normal", 80, 109);
