...
tft.fillRoundRect(22, 93, 86, 10, 2, TFT_ORANGE);
tft.fillRect(108, 93, 30, 10, TFT_BLACK);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.setTextDatum(TC_DATUM);
tft.setTextColor(TFT_ORANGE, TFT_BLACK);
tft.drawString("Ruidoso", 80, 109);
