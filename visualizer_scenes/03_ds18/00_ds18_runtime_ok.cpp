...
int ds18IntW = tft.textWidth("24");
tft.setFreeFont(&Roboto_Regular7pt8b);
int ds18DecW = tft.textWidth(".7");
int ds18StartX = 60 - (ds18IntW + ds18DecW) / 2;
tft.setTextColor(TFT_GREEN, TFT_BLACK);
tft.setFreeFont(&IBMPlexMono_Regular24pt8b);
tft.drawString("24", ds18StartX, 50);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.drawString(".7", ds18StartX + ds18IntW, 50);
...
tft.fillRect(121, 85, 26, 12, TFT_GREEN);
