...
int ds18IntW = tft.textWidth("33");
tft.setFreeFont(&Roboto_Regular7pt8b);
int ds18DecW = tft.textWidth(".1");
int ds18StartX = 60 - (ds18IntW + ds18DecW) / 2;
tft.setTextColor(TFT_RED, TFT_BLACK);
tft.setFreeFont(&IBMPlexMono_Regular24pt8b);
tft.drawString("33", ds18StartX, 50);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.drawString(".1", ds18StartX + ds18IntW, 50);
...
tft.fillRect(121, 85, 26, 12, TFT_RED);
