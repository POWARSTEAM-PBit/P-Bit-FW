...
int tempIntW = tft.textWidth("14");
tft.setFreeFont(&Roboto_Regular7pt8b);
int tempDecW = tft.textWidth(".2");
int tempStartX = 60 - (tempIntW + tempDecW) / 2;
tft.setTextColor(TFT_BLUE, TFT_BLACK);
tft.setFreeFont(&IBMPlexMono_Regular24pt8b);
tft.drawString("14", tempStartX, 50);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.drawString(".2", tempStartX + tempIntW, 50);
...
tft.fillRect(121, 82, 26, 41, TFT_BLUE);
tft.drawFastHLine(121, 82, 26, TFT_WHITE);
