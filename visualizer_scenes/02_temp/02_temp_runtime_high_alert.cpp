...
int tempIntW = tft.textWidth("33");
tft.setFreeFont(&Roboto_Regular7pt8b);
int tempDecW = tft.textWidth(".6");
int tempStartX = 60 - (tempIntW + tempDecW) / 2;
tft.setTextColor(TFT_RED, TFT_BLACK);
tft.setFreeFont(&IBMPlexMono_Regular24pt8b);
tft.drawString("33", tempStartX, 50);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.drawString(".6", tempStartX + tempIntW, 50);
...
tft.fillRect(121, 46, 26, 78, TFT_RED);
tft.drawFastHLine(121, 46, 26, TFT_WHITE);
