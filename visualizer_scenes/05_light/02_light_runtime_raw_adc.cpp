...
const char* value_str = "1234";
const char* unit_str = "raw";
...
tft.fillRoundRect(22, 93, 26, 10, 2, TFT_CYAN);
tft.fillRect(48, 93, 88, 10, TFT_BLACK);
tft.fillRect(0, 106, 160, 16, TFT_BLACK);
tft.setTextDatum(MC_DATUM);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.setTextColor(TFT_CYAN, TFT_BLACK);
tft.drawString("Tenue", 80, 114);
tft.fillCircle(14, 118, 4, TFT_CYAN);
tft.drawCircle(14, 118, 4, TFT_CYAN);
