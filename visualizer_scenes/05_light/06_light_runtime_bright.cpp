...
tft.fillRoundRect(22, 93, 88, 10, 2, TFT_YELLOW);
tft.fillRect(110, 93, 26, 10, TFT_BLACK);
tft.fillRect(0, 106, 160, 16, TFT_BLACK);
tft.setTextDatum(MC_DATUM);
tft.setFreeFont(&Roboto_Regular7pt8b);
tft.setTextColor(TFT_YELLOW, TFT_BLACK);
tft.drawString("Brillante", 80, 114);
tft.fillCircle(14, 118, 4, TFT_YELLOW);
tft.drawCircle(14, 118, 4, TFT_YELLOW);
