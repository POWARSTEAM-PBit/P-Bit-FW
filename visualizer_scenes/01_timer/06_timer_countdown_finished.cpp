// Scene: timer_countdown_finished
...
timerSprite.setTextColor(TFT_RED, TFT_BLACK);
timerSprite.setFreeFont(&IBMPlexMono_Regular12pt8b);
timerSprite.drawString("00:00:00", 61, 15);
...
tft.setFreeFont(&Roboto_Light6pt8b);
tft.setTextColor(TFT_DARKGREY, TFT_BLACK);
tft.drawString("Pulsa seguir · Mant reset", 80, 34);
tft.setTextFont(0);
