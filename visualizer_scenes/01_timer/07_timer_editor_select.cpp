...
tft.drawString("Pulsa editar · Mant guardar", 80, 118);
tft.setTextFont(0);

tft.fillRect(14, 54, 132, 46, TFT_BLACK);
tft.fillRect(19, 59, 122, 36, TFT_BLACK);
tft.drawRoundRect(16, 56, 128, 42, 4, TFT_BLUE);
...
const char* mm = "05";
const char* ss = "00";
const uint16_t selected_color = TFT_YELLOW;
