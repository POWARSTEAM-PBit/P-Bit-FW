...
// Product/sensor screen titles
/* TIT_LAB_DASH      */ { "ESTADO LAB",           "ESTAT LAB",            "LAB OVERVIEW"       },
/* TIT_LAB_FOCUS     */ { "SENSOR",               "SENSOR",               "SENSOR"             },
/* TIT_LAB_DUAL_TH   */ { "CLIMA LAB",            "CLIMA LAB",            "CLIMATE LAB"        },
/* TIT_LAB_PLANT     */ { "PLANTA LAB",           "PLANTA LAB",           "PLANT LAB"          },
/* TIT_LAB_ICON_A    */ { "CONTORNO",             "CONTORN",              "OUTLINE"            },
/* TIT_LAB_ICON_B    */ { "SÓLIDO",               "SÒLID",                "SOLID"              },
/* TIT_LAB_ICON_C    */ { "PÍXEL",                "PÍXEL",                "PIXEL"              },
/* TIT_LAB_GAUGE     */ { "RANGO",                "RANG",                 "RANGE"              },
/* TIT_LAB_VALUE     */ { "DATO",                 "DADA",                 "DATA"               },
/* TIT_LAB_TEMP_CARD */ { "TEMP. FICHA",          "TEMP. FITXA",          "TEMP. INFO"         },
/* TIT_LAB_PROBE_CARD */ { "TERMO FICHA",         "TERMO FITXA",          "THERMO INFO"        },
/* TIT_LAB_HUM_CARD  */ { "HUM. FICHA",           "HUM. FITXA",           "HUM. INFO"          },
/* TIT_LAB_LIGHT_CARD*/ { "LUZ FICHA",            "LLUM FITXA",           "LIGHT INFO"         },
/* TIT_LAB_SOUND_CARD*/ { "SONIDO FICHA",        "SO FITXA",             "SOUND INFO"         },
/* TIT_LAB_SOIL_CARD */ { "SUE. FICHA",           "SÒL FITXA",            "SOIL INFO"          },
/* TIT_LAB_WIDGETS   */ { "TERMO LAB",            "TERMO LAB",            "THERMO LAB"         },
/* TIT_LAB_VU_STACK  */ { "SONIDO VU",            "SO VU",                "SOUND VU"           },
/* TIT_LAB_VU_WAVE   */ { "SONIDO ONDA",          "SO ONA",               "SOUND WAVE"         },
...
/* PLANT_STATE_OK_KEY */ { "BIEN",                "BÉ",                   "OK"                 },
/* PLANT_STATE_THIRSTY_KEY */ { "SEDIENTA",       "ASSEDEGADA",           "THIRSTY"            },
/* PLANT_STATE_SOGGY_KEY */ { "AHOGADA",          "OFEGADA",              "SOGGY"              },
/* PLANT_STATE_STRESSED_KEY */ { "ESTRÉS",        "ESTRÈS",               "STRESSED"           },
/* SOIL_ZONE_DRY       */ { "Sec",                "Sec",                  "Dry"                },
/* SOIL_ZONE_OK        */ { "Ok",                 "Bé",                   "Ok"                 },
/* SOIL_ZONE_WET       */ { "Hum",                "Hum",                  "Wet"                },
/* SZ_SUFFIX_CARD      */ { "FICHA",              "FITXA",                "INFO"               },
/* SZ_SUFFIX_VALUE     */ { "DATO",               "DADA",                 "DATA"               },
/* SZ_SUFFIX_GRAPH     */ { "CURVA",              "CORBA",                "CURVE"              },
/* SZ_SUFFIX_DIAL      */ { "RANGO",              "RANG",                 "RANGE"              },
};
